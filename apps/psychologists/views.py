...
def search(request, format=None):
  ...
  if name or specialization or work_population or therapeutic_model:
    ...
    if work_population is not None: 
        psychologists = psychologists.filter(work_population__icontains=work_population)

    if therapeutic_model is not None: 
        psychologists = psychologists.filter(therapeutic_model__icontains=therapeutic_model)
